...
var displayMap = function displayMap(locations) {
  ...
  locations.forEach(function (loc) {
    ...
    el.className = 'marker'; // agregar esos puntos en el mapa
    ...
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            _context.prev = 0;
            url = type === 'password' ? 'http://localhost:8000/api/v1/users/update_my_password' : 'http://localhost:8000/api/v1/users/update_me';
            _context.next = 4;
            return (0, _axios.default)({
              method: 'PATCH',
              url: url,
  ...
  var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(tourId) {
    ...
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            stripe = Stripe("pk_test_51IeM72IOHPNKHCPQre2jIp2SYmQEsI9xYR7RmSFTsm8byZa1btb5WqwjUnXNJobghuHA2mdDEbuM65BpkgF4ppy100mUmrKHxk");
            _context.prev = 1;
            _context.next = 4;
